    ...
    let gen = quote! {
        impl #impl_generics bevy_ecs_ldtk::prelude::LdtkEntity for #struct_name #ty_generics #where_clause {
            fn bundle_entity(
                ...
                atlas: &mut Option<Handle<bevy::prelude::TextureAtlas>>,
...
fn expand_sprite_sheet_bundle_attribute(
        ...
        .expect("Cannot parse #[sprite_sheet_bundle...] attribute")
    {
        ...
        syn::Meta::List(syn::MetaList { nested, .. }) if nested.len() == 1 => {
            ...
            quote! {
                #field_name: bevy_ecs_ldtk::utils::sprite_sheet_bundle_from_entity_info(entity_instance, tileset,atlas, tileset_definition, texture_atlases, false),
            }
        },
        syn::Meta::Path(_) => {
            quote! {
                #field_name: bevy_ecs_ldtk::utils::sprite_sheet_bundle_from_entity_info(entity_instance, tileset, atlas, tileset_definition, texture_atlases, true),
            }
        },
...
fn expand_ldtk_entity_attribute(
        ...
        .expect("Cannot parse #[ldtk_entity] attribute")
    {
        syn::Meta::Path(_) => {
            quote! {
                #field_name: <#field_type as bevy_ecs_ldtk::prelude::LdtkEntity>::bundle_entity(entity_instance, layer_instance, tileset, atlas, tileset_definition, asset_server, texture_atlases),
            }
        }
